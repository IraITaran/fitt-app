    ...
    return (
        <div className="About">
                ...
                <div className="container">
                    <div className="about-info">
                        ...
                        <span>
                            ...
                            торгового опыта от опытных трейдеров к начинающим
                        </span>
                    </div>
                </div>
            </div>
                ...
                <div className="container">
                    ...
                    <div className="d-grid advantages-main-grid">
                        <div className="advantages-section">
                            ...
                            <p>
                                Мы сотрудничаем с топовыми криптовалютными
                                биржами для предоставления наилучшего опыта в
                                социальной торговле
                            </p>
                        </div>
                        <div className="advantages-section">
                            ...
                            <p>
                                Мы применяем строгие меры безопасности, чтобы
                                обеспечить непрерывную защиту ваших средств и
                        ...
                        <div className="advantages-section">
                            ...
                            <p>
                                Изучайте торговую историю лидеров рынка и
                                присоединяйтесь к самым успешным сделкам на
                                основе их стратегий ‌
                            </p>
                        </div>
                    </div>
                            ...
                            <ul>
                                <li>
                                    <img
                                        ...
                                        alt="list-icon"
                                    ></img>
                                    Получайте пассивный доход, следуя
                                    проверенным стратегиям топ-трейдеров
                                </li>
                                <li>
                                    <img
                                        src={ListFlowIcon}
                                        alt="list-icon"
                                    ></img>
                                    Автоматически присоединяйтесь к
                                    разнообразным стратегиям с минимальным
                                ...
                                <li>
                                    <img
                                        ...
                                        alt="list-icon"
                                    ></img>
                                    Сохраняйте контроль над активам. Разместите
                                    стоп-лосс и остановите копирование в любое
                                    время
                                </li>
                                <li>
                                    <img
                                        ...
                                        alt="list-icon"
                                    ></img>
                                    Оставайтесь спокойными: ваши активы на
                                    Binance находятся под надежной защитой
                                </li>
                            </ul>
                            <button className="yellow-btn">
                                Перейти к списку портфелей
                            </button>
                        </div>
                        <div className="flow-right-section">
                            ...
                            <ul>
                                <li className="grey-item">
                                    <span>01.</span>Выберите понравившиеся
                                    портфели для слежения
                                </li>
                                <li className="black-item">
                                    <span>02.</span>Выберите сумму депозита и
                                    установите стоп-лосс
                                </li>
                                <li className="grey-item">
                                    <span>03.</span>Наблюдайте как лучшие
                                    трейдеры ведут вас по сделкам
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div className="about-footer text-center">
                ...
                <p>
                    Достигайте поставленных результатов профита на рынке
                    криптовалют!
                </p>
                <ul>
                    <li>
