    ...
    <div className="About">
      <div className="about-header-container d-flex justify-content-between">
        <div className="main-left">
          <p>
            FItt — это не просто платформа, это ваш <br/>ключ к успеху
          </p>
          <span>
          Откройте для себя FItt — уникальную социальную платформу,<br/>
           созданную для трансформации торгового опыта, где опытные трейдеры <br/>
            помогут начинающим мастерить искусство успешной торговли. <br/>
            Присоединяйтесь к нашему дружественному сообществу и обогатите свои знания,<br/>
             получая ценные советы и стратегии от профессионалов.<br/>
              Вместе с FItt вы станете частью революции в мире криптовалютной торговли, <br/>
              где знания и опыт становятся двигателем вашего успеха и финансового благополучия.
          </span>
        </div>
