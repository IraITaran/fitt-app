...
export default function ApiManagement() {
    ...
    function createApiKey() {
        UserService.updateApiKey(name, apiKey, apiSecret, 1).then(
            (response) => {
    ...
    return (
        <>
            <div className="ApiManagement">
                <div className="api-info-container container">
                    <div className="api-info-header d-flex flex-column flex-md-row justify-content-md-between">
                        <h1>Управление API</h1>
                        <div className="api-management-buttons d-flex flex-column flex-xl-row">
                            <button
                                type="button"
                    ...
                    <ol className="api-info-list">
                        <li>
                            На каждом аккаунте может быть создан только один API
                            ключ.
                        </li>
                        <li>
                            Не раскрывайте никому свой ключ API, секретный ключ
                            (HMAC) или приватный ключ (RSA) во избежание потери
                            активов. Вы должны относиться к своему ключу API,
                            секретному ключу (HMAC) или приватному ключу (RSA)
                            так же, как и к своим паролям.
                        </li>
                        <li>
                            Для повышения безопасности и корректной работе
                            учетной записи необходимо разрешать доступ к
                            доверенным IP-адресам. Вам необходимо указать IP
                            адрес нашего сервера: 139.99.121.36
                        </li>
                        <li>
                            При генерации ключа необходимо выбрать управление
                            Фьючерсным аккаунтом. Не выбирайте доступ к снятию
                            денежных средств, для коректной работы бота эти
                            права не нужны.
                        </li>
                    </ol>
                            ...
                            <div
                                ...
                                <div className="apikey-section">
                                    ...
                                    <p className="apikey-value">
                                        <span className="apikey-value-text">
                                            {item.key}
                                        </span>
                                        <span
                                            className={
                ...
                <Modal.Body className="apikeyModal">
                    ...
                    {!isSaved && (
                        <p
                            ...
                            При генерации API ключа необходимо разрешить доступ
                            к USDT Futures, а также добавить IP-адрес{" "}
                            <b>13.229.50.26</b> в список разрешенных IP-адресов.{" "}
                            <br />
                            <a href="/">Подробнее...</a>
                        </p>
                    )}
