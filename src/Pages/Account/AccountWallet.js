    ...
    return (
        <>
            <div className="AccountWallet">
                <div className="user-info-container">
                    <div className="d-flex">
                        ...
                        <div>
                            ...
                            <div className="d-flex flex-column flex-md-row wallet-wrapper">
                    ...
                    <div className="d-flex flex-column flex-md-row user-info-footer">
                        <div className="estimated-balance">
                            ...
                            <div className="estimated-balance-amount d-flex">
                        ...
                        <div className="referrals">
                            ...
                            <div className="referrals-mount d-flex">
                                <p>2</p>
                                <p>+0</p>
                            </div>
                        </div>
                    </div>
                    <div className="d-flex flex-column flex-md-row wallet-buttons">
                ...
                <div className="user-statistics-container d-flex flex-column align-items-start">
                    <div className="container">
                        <div className="user-statistics-title">
                            <h3>Торговля</h3>
                        </div>
