    ...
    return (
        <div className="BotManagementCard">
            {/* <div className="row">
                <div className="mb-4">
                    {props.data.type === 0 && (
                        <span className="bot-type">Copy</span>
                    )}
                    {props.data.type === 1 && (
                        <span className="bot-type">Open</span>
                    )}
                    {props.data.type === 2 && (
                        <span className="bot-type">Notify</span>
                    )}
                    {account && <span className="account-type">{account}</span>}
                </div>
            </div> */}
            
            <div className="bot-management-card-info d-flex">
                
                <div className="card-info-column flex-grow-1">
                <div className="bot-management-card-header d-flex">
                <img
                    src={UnknownIcon}
                    alt="unknown-icon"
                    className="user-account-icon"></img>
                <div className="card-header-info">
                    ...
                    <div>
                        <p className="bot-option">
                            <span>ID:</span>{props.data.id}
                        </p>
                    </div>
                </div>
                {/* <div className="card-header-buttons d-flex">
                    <div className="card-header-btn"></div>
                    <div className="card-header-btn"></div>
                </div> */}
            </div>
            <p className="bot-option d-flex">
                        <span>Имя:</span>
                         Doge
                    </p>
                    <p className="bot-option d-flex">
                        ...
                        {new Date(props.data.createdDate).toLocaleDateString() +
                            " | " +
                            new Date(props.data.createdDate).toLocaleTimeString(
                                "es-ES"
                            )}
                    </p>
                    <p className="bot-option d-flex">
                ...
                <p
                        className={
                            props.data.status === 1
                                ? "bot-option green d-flex"
                                : props.data.status === 2
                                ? "bot-option red d-flex"
                                : "bot-option d-flex"
                        }>
                        <span>Статус: </span>{" "}
                        {props.data.status === 0
            ...
            <div className="bot-button-container d-flex">
                <div
                    onClick={showModal}
                ...
                <div
                    onClick={() => navigate("/leader/" + props.data.leaderKey)}>
                    <img
                        src={statisticBotIcon}
                        alt="statistic-icon"></img>
                </div>
            </div>
                ...
                <Modal.Body>
                        ...
                        <div className="radio-buttons-wrapper">
                            ...
                            <label>
                                ...
                                <span
                                    ...
                                    (общая сумма с учетом коефициента:{" "}
                                    {negativePNLChoiceAmount}$)
                                </span>
                            </label>
                            <label>
                    ...
                    {disableRun && (
                        <div className="insufient-funds-warning">
                            Текущие позиции трейдера превыщают Ваш доступный
                            баланс с учетом коэффициента. Пересмотрите
                            коэффициент или пополните баланс на Futures
                            кошельке.
                        </div>
                    )}
                    <div className="text-center">
