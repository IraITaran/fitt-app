...
export default function BotManagementCard(props) {
    ...
    return (
        <div className="BotRunOptionForm">
            <div className="bot-option-container container">
                    ...
                    <div className="radio-buttons-wrapper">
                        <label>
                            <input
                                ...
                                disabled={onlyNotify}
                            />
                            <p>Копировать только новые позиции</p>
                        </label>
                        <label>
                            <input
                                type="radio"
                ...
                {availableBalance < allPositionChoiceAmount && (
                    <span className="red">
                        Если сумма под контролем бота меньше чем открытые
                        позиции трейдера, рекомендуем уменьшить коэфициент
                        вернувшись на предыдущий пункт конфигурации
                    </span>
                )}
                <div className="text-center">
                    <h5 className="table-title">Открытые позиции трейдера</h5>
                    <div className="table-container">
                        ...
                        <div className="table-empty-bg"></div>
                    </div>
                </div>
                {disableRun && (
                    <div className="insufient-funds-warning">
                        Текущие позиции трейдера превыщают Ваш доступный баланс
                        с учетом коэффициента. Пересмотрите коэффициент или
                        пополните баланс на Futures кошельке.
                    </div>
                )}
                <div className="bot-options-button-container d-flex flex-column flex-md-row justify-content-md-center">
                    <button
                        type="button"
                        className="save-btn"
                        onClick={save}>
            ...
            <Modal
                ...
                <Modal.Body>
                    <h4 className="approve-text">
                        У Вас нет активной подписки. Вы можете сохранить
                        настройки бота и запустить его после оплаты.
                    </h4>
                    <button
                        type="button"
